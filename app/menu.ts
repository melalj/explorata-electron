      ...
      submenu: [
        {
          label: 'Learn More',
          click() {
            shell.openExternal('https://explorata.io');
          }
        },
        {
          label: 'Instructions to Get Facebook Data',
          click() {
        ...
        },
        {
          ...
          click() {
            shell.openExternal('https://github.com/melalj/explorata/issues');
          }
        }
      ]
    };
